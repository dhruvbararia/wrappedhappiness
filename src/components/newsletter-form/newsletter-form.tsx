  ...
  return (
    ...
    >
      ...
      <div className="control">
        <button
          className="-mt-px inline-flex cursor-pointer justify-center whitespace-nowrap rounded-sm border-0 bg-gradient-to-r from-[#c6b0d5] to-[#decbeb] px-7 py-4 text-center font-medium leading-4 text-[#f3eac1] no-underline shadow-lg"
          type="submit"
        >
          {submitText}
        </button>
